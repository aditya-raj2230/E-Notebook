...
const Leftpanel = () => {
  ...
  return (
    <div className={`h-screen w-20 m-4 bg-black ${expand?"w-96":"w-20"} `} >
      ...
      <button onClick={()=>setExpand((curr)=>!curr)}>{expand?<div><h2 className='text-white align m-0 pb-14 h-2 bg-yellow hover:text-yellow-700 text-6xl'>&lt;</h2></div>:<img src={pageBtnImg} alt="" className='' />}</button>
      </div>
